...
from sqlalchemy import Boolean, Date, DateTime, ForeignKey, JSON, String, Uuid, func
...
class User(Base):
    ...
    mascot_name: Mapped[str] = mapped_column(String(100), nullable=False, default="Tuga")
